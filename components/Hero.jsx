      ...
      <div className="wrapper grid grid-cols-1 lg:grid-cols-2 gap-10 justify-center items-center">
        ...
        <div className="hero-left flex flex-col gap-1 lg:gap-2 justify-between">
          ...
          <div className="overflow-hidden">
            ...
            >
              Creative full stack web and app developer
            </h1>
          </div>
          <div className="overflow-hidden">
            <p
            ...
            >
              Passionate MERN/PERN developer based in India, pushing boundaries
          ...
          <div className="space-y-2">
            ...
            <div className="social flex gap-5 text-2xl overflow-hidden">
              ...
              >
                <Link
                  href="https://github.com/singhjassii"
                  target="_blank"
              ...
              >
                <Link
                  href="https://leetcode.com/u/jaspreetsingh9881"
                  target="_blank"
              ...
              >
                <Link
                  href="https://www.linkedin.com/in/jaspreet-siingh/"
                  target="_blank"
                  className="text-3xl hover:text-accent duration-500"
                >
                  <BiLogoLinkedin />
              ...
              >
                <Link
                  href="https://www.instagram.com/singh.jassii/"
                  target="_blank"
                  className="text-3xl hover:text-accent duration-500"
                >
                  <BiLogoInstagram />
              ...
              >
                <Link
                  href="https://www.facebook.com/profile.php?id=100007429262406"
                  target="_blank"
                  className="text-3xl hover:text-accent duration-500"
                >
                  <BiLogoFacebook />
        ...
        <div className="hero-right hidden lg:flex items-center justify-center content-center">
          <div className="hero-image-sec rounded-full w-3/4 h-3/4 relative">
            <div className="overflow-hidden rounded-full">
              ...
              >
                <Image
                  src="https://res.cloudinary.com/dwv15efmr/image/upload/v1737112571/IMG_20240824_213531_193_enhanced_z4wi3n.png"
                  alt="Jaspreet Singh"
                  width={500}
                  height={500}
                  priority
