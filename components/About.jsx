    ...
    <section id="about" className="wrapper section-padding">
      ...
      <div className="about-content grid grid-cols-1 lg:grid-cols-2 lg:text-left justify-center items-center gap-10 mt-20 overflow-hidden">
        ...
        <div className="about-left relative lg:p-10 lg:mb-10">
          ...
          >
            <Image
              src="https://res.cloudinary.com/dwv15efmr/image/upload/v1737114428/Untitled_design_enhanced_1_it79ly.jpg"
              alt="Jaspreet Singh"
              width={500}
              height={500}
        ...
        <div className="about-right space-y-5 lg:p-10">
          ...
          <div className="overflow-hidden">
            ...
            >
              ...
              and <span className="text-accent">innovative</span> web and app
          ...
          <div className="overflow-hidden">
            ...
            >
              ...
              JavaScript and its ability to create dynamic web and mobile
              applications. My journey into web development began in July 2022 I
